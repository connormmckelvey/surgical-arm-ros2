...
class CameraCalibrationNode(Node):
    ...
    def process_and_update_mesh(self):
        ...
        self.final_normal_vector_marker_msg.pose.position.x = float(self.final_centroid[0])
        self.final_normal_vector_marker_msg.pose.position.y = float(self.final_centroid[1])
        self.final_normal_vector_marker_msg.pose.position.z = float(self.final_centroid[2])
        self.final_normal_vector_marker_msg.pose.orientation.w = 1.0
        self.final_normal_vector_marker_msg.scale.x = 0.06
        self.final_normal_vector_marker_msg.scale.y = 0.06
        self.final_normal_vector_marker_msg.scale.z = 0.06
